...
- **Close (one soft ask — and ROTATE it across peers)** — a single, low-pressure invitation to talk shop: "Would value connecting and hearing what the work on {team/area} is actually like" or "Grateful to connect and swap notes on {domain}". Aim for a short chat / coffee, not a hard pitch. When you're reaching several peers at the same company, VARY which angle you ask about so the conversations don't read as one copied script — rotate among: what the day-to-day work is actually like; how they approached a specific project/challenge; what the team culture and trajectory feel like; how they broke into the field; what they'd tell someone finishing an MS aiming at this work. One ask each, varied across people.
