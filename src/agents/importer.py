...
from src.core.profile import coerce_focus_label, load_profile
...
def parse_contacts_file_with_report(
    ...
    *,
    ...
    # Focus labels a pre-labeled file may carry are validated against the
    # active profile's taxonomy (shared coerce_focus_label; None → classify).
    ...
    for raw in raw_rows:
        ...
        candidates.append(
            ContactCandidate(
                ...
                focus_area=coerce_focus_label(canon.get("focus_area"), profile, default=None),
